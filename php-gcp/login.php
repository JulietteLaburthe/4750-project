...
?>
  ...
  <br><br><br><br>
  <div class="container" style="text-align: center;width: 500px;height:400px;background-color:black;border-radius: 25px;">
  <br>
<form name="mainForm" action="login.php" method="post">   
  ...
  <input type="submit" value="Login" name="btnAction" class="btn btn-dark" 
        title="Login"  style="height:50px;width:300px;color:white;background-color:#f44fb1;font-family: sans-serif;font-size:25px"/>  
</form>
  </div>
  </body>
