...
function login($email, $password)
{
    ...
    if ($results == null) {
        ...
        if (password_verify($password, $results[2])) {
			...
			echo '<a href="https://localhost/php-gcp/add_media.php?email=' . $email . '">Login Successful! Click here to start Adding Media to Your Watchlist!</a>';
...
function signup($email,$username,$password){
	...
	echo '<a href="https://localhost/php-gcp/add_media.php?email=' . $email . '">Sign Up Successful! Click here to start Adding Media to Your Watchlist!</a>';;
